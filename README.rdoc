...
cd db/data && export_kalading.bat && cd .. && bsdtar zcf data.tar.gz data && scp -pw Kalading123 data.tar.gz azureuser@42.159.24.222:/mnt/kalading/db/  && rm -f data.tar.gz && cd .. && bsdtar zcf app.tar.gz app/ && scp -pw Kalading123 app.tar.gz azureuser@42.159.24.222:/mnt/kalading/ && rm -f app.tar.gz && bsdtar zcf config.tar.gz config/ && scp -pw Kalading123 config.tar.gz azureuser@42.159.24.222:/mnt/kalading/ && rm -f config.tar.gz && ssh azureuser@42.159.24.222 "cd /mnt/kalading; tar zxf app.tar.gz; rm -f app.tar.gz; tar zxf config.tar.gz; rm -f config.tar.gz; bundle exec rake db:reseed; cd db; tar zxf data.tar.gz; cd data; ./import_kalading.bat; cd ..; cd ..; rm -rf public/assets; RAILS_ENV=production bundle exec rake assets:precompile; sudo stop kalading; sudo start kalading"

== Update code & assets to beijing
bsdtar zcf app.tar.gz app/ && scp -pw Kalading123 app.tar.gz azureuser@42.159.24.222:/mnt/kalading/ && rm -f app.tar.gz && bsdtar zcf config.tar.gz config/ && scp -pw Kalading123 config.tar.gz azureuser@42.159.24.222:/mnt/kalading/ && rm -f config.tar.gz && ssh azureuser@42.159.24.222 "cd /mnt/kalading; tar zxf app.tar.gz; rm -f app.tar.gz; tar zxf config.tar.gz; rm -f config.tar.gz; rm -rf public/assets; RAILS_ENV=production bundle exec rake assets:precompile; sudo stop kalading; sudo start kalading"

== Update code to beijing
bsdtar zcf app.tar.gz app/ && scp -pw Kalading123 app.tar.gz azureuser@42.159.24.222:/mnt/kalading/ && rm -f app.tar.gz && bsdtar zcf config.tar.gz config/ && scp -pw Kalading123 config.tar.gz azureuser@42.159.24.222:/mnt/kalading/ && rm -f config.tar.gz && ssh azureuser@42.159.24.222 "cd /mnt/kalading; tar zxf app.tar.gz; rm -f app.tar.gz; tar zxf config.tar.gz; rm -f config.tar.gz; sudo stop kalading; sudo start kalading"

== Update Gemfile to beijing and bundle
scp -pw Kalading123 Gemfile azureuser@42.159.24.222:/mnt/kalading/ && ssh azureuser@42.159.24.222 "cd /mnt/kalading; bundle install --deployment --without development test"

== Fetch dababase from azure beijing
cd db && ssh azureuser@42.159.24.222 "cd /mnt/kalading/db/data; rm -f *.json; ./export_kalading.bat; cd ..; tar zcf data.tar.gz data" && scp -pw Kalading123 azureuser@42.159.24.222:/mnt/kalading/db/data.tar.gz ./ && bsdtar zxf data.tar.gz && cd .. && rake db:reseed && cd db/data/ && import_kalading.bat

== Backup database on azure bj to aliyun
ssh-keygen
ssh-copy-id root@115.28.132.220


== Change editor to vim
export EDITOR=/usr/bin

== Set time zone on ubuntu server
sudo dpkg-reconfigure tzdata

== Update code & assets to tokyo
bsdtar zcf app.tar.gz app/ && scp -i tokyo_new.ppk app.tar.gz ubuntu@54.248.126.168:/mnt/kalading/ && rm -f app.tar.gz && bsdtar zcf config.tar.gz config/ && scp -i tokyo_new.ppk config.tar.gz ubuntu@54.248.126.168:/mnt/kalading/ && rm -f config.tar.gz && ssh ubuntu@54.248.126.168 "cd /mnt/kalading; tar zxf app.tar.gz; rm -f app.tar.gz; tar zxf config.tar.gz; rm -f config.tar.gz; rm -rf public/assets; RAILS_ENV=production bundle exec rake assets:precompile; sudo stop kalading; sudo start kalading"

== Update Gemfile to tokyo
scp -i tokyo_new.ppk Gemfile ubuntu@54.248.126.168:/mnt/kalading/ && ssh ubuntu@54.248.126.168 "cd /mnt/kalading; bundle install"

== Update database to tokyo
cd db/data && export_kalading.bat && cd .. && bsdtar zcf data.tar.gz data && scp -i ../tokyo_new.ppk data.tar.gz ubuntu@54.248.126.168:/mnt/kalading/db/ && ssh ubuntu@54.248.126.168 "cd /mnt/kalading; bundle exec rake db:reseed; cd db; tar zxf data.tar.gz; cd data; ./import_kalading.bat"